...
> Note: These answers reflect standard Riel heuristics. Verify that each matches how it was specifically discussed and illustrated in your lectures before submitting.
...
**Name:**
Keep related data and behavior together (Behavior belongs with the data it operates on).
